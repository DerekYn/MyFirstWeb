...
<script type="text/javascript">
	...
	function goMove(post1, post2, address) {
		...
		$("#post1", opener.window.document).val(post1);
		$("#post2", opener.window.document).val(post2);
		$("#addr1", opener.window.document).val(address);
		
		$("#addr2", opener.window.document).focus();
