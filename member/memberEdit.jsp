...
<table id="tblMemberRegister">
	...
	<tr>
		...
		<td style="width: 80%; text-align: left;"><input type="password" id="pwdcheck" class="requiredInfo" required /> 
			<span id="error_passwd">암호가 일치하지 않습니다.</span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="width: 80%; text-align: left;">
		   <input type="text" name="post1" id="post1" value="<%= mvo.getPost1() %>" size="4" maxlength="3" />-
		   <input type="text" name="post2" id="post2" value="<%= mvo.getPost2() %>" size="4" maxlength="3" />&nbsp;&nbsp;
		   <!-- 우편번호 찾기 -->
	...
	<tr>
		<td colspan="2">
			<button type="button" id="btnUpdqte" style="margin-left: 40%; margin-top: 5%; width: 70px; height: 30px" onClick="goEdit(event);"><span style="font-size: 15pt">확인</span></button>
		</td>
	</tr>
	</tbody>
</table>
